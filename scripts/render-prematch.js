...
const compositionPath = path.join(root, "compositions", "prematch-prediction.html");
...
// Inject transcript — escape </script> sequences to prevent HTML injection
...
// Extend composition duration to cover full audio (add 0.5s buffer)
...
// Copy voiceover audio into render cache so relative path resolves
